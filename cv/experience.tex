...
\begin{cventries}
    ...
    \cventry{Contract Senior DevOps Engineer}
    {Omnio Group}
    {Remote, United Kingdom}
    {Dec. 2021 — Dec. 2022 }
    {
    ...
    \cventry{Vice President - Site Reliability}
    {Goldman Sachs}
    ...
    \cventry{Contract Senior Site Reliability Engineer}
    {Capita / DWP}
    ...
    \cventry{Contract Senior Business Architecture Lead}
    {Lloyds Bank}
    {Central London, UK}
    {Jun. 2017 — Nov. 2017}
    {
    ...
    %---------------------------------------------------------
    \cventry{Contract DevOps Consultant} % Job title
    {EDF} % Organization
    ...
    \cventry{Contract DevOps Consultant (SC Cleared)} % Job title
    ...
    \cventry{Contract DevOps Tech Lead (SC Cleared)} % Job title
    ...
    \cventry{Contract Build Engineer (SC Cleared)} % Job title
